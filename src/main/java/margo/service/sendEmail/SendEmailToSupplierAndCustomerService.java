...
//        System.out.println(subject);
        ...
        StringBuffer sb = new StringBuffer("<html><body><table><tr>" +"<td width=\"35%\">Image</td>"+
                "<td width=\"25%\">Название</td><td width=\"10%\">Описание</td><td width=\"10%\">Кол-во</td>" +
                "<td width=\"10%\">Цена</td><td width=\"20%\">Сумма</td></tr>");
        int i = -1;
        int numberPage=0;
        ...
        for (String properties : list) {
            ...
            System.out.println("Name: "+name+" Quantity: "+quantity+" Photo: "+photo+" Price: "+price);
            //two signs after a comma
            value= new BigDecimal(valueBeforeRound).setScale(2, RoundingMode.UP).doubleValue();
            nameArrays.add("<tr><td><img src=\"http://http://localhost:8080/"+photo+"\" width=\"30%\" height=\"30%\">" +
