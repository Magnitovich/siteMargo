package margo.model.finishedProduct;

import javax.persistence.*;
import java.math.BigDecimal;

@Entity
@Table(name = "CURTAIN_FINISHED", schema = "public")
public class CurtainFinishedModel extends AllFinishProductModel {
    ...
    public void setItIsSewed(String itIsSewed) {
        this.itIsSewed = itIsSewed;
    }
